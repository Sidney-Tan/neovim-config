return {
  {
    ...
    lazy = true,
    keys = {
      { "<leader><F3>", "<cmd>Tlist<CR>", mode = { "n", "i" }, desc = "Tlist" },
    },
    config = function()
      -- set tlist configs
      vim.api.nvim_command("let Tlist_Show_One_File=1")
      vim.api.nvim_command("let Tlist_Ctags_Cmd='/usr/bin/ctags'")
      vim.api.nvim_command("let Tlist_Use_Right_Window=1")
      vim.api.nvim_command("let Tlist_Exit_OnlyWindow=1")
      vim.api.nvim_command("let Tlist_WinWidth=35")
    end,
  },
  {
    ...
    keys = {
      { "<F3>", "<cmd>Outline<CR>", mode = { "n", "i" }, desc = "Outline" },
    },
  },
}
